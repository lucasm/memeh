...
const CookiesConsentContext = createContext<CookiesConsentContextValue | null>(null)

export const CookiesConsentContextProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <CookiesConsentContext.Provider value={{ isAccepted, isHydrated, openPopup, accept, reject }}>
      {children}
...
export const useCookiesConsent = () => {
  ...
  if (!ctx) throw new Error('useCookiesConsent must be used within CookiesConsentContextProvider')
  return ctx
}
